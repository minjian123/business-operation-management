...
- **PC 管理端全部界面组件**：表格（el-table）、表单（el-form）、树（el-tree）、弹窗（el-dialog）、上传等覆盖后台全场景（见《[项目规划说明](../../../规划/项目规划说明.md#sel-frontend)》3.2 节）。
- **中文社区生态最大**：问题检索与组件用法资料最全，团队上手与排障成本低（见《[项目规划说明](../../../规划/项目规划说明.md#stack-frontend)》2.2 节）。
...
| 文档 | 说明 |
| --- | --- |
| 《[项目规划说明](../../../规划/项目规划说明.md#stack-frontend)》2.2 节 | 前端技术栈（Element Plus 条目） |
| 《[项目规划说明](../../../规划/项目规划说明.md#sel-frontend)》3.2 节 | 选型理由：生态最大、组件齐全、主题可定制 |
