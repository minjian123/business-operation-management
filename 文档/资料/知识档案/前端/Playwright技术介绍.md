...
- **定位**：BMS E2E 测试框架，main 流水线独立 job 运行（见《[项目规划说明](../../../规划/项目规划说明.md#stack-frontend)》2.2 节）。
...
- **E2E 覆盖范围**：登录、主体链 RBAC 权限（含按钮显隐与字段权限）、核心 CRUD 主流程（见《[项目规划说明](../../../规划/项目规划说明.md#test)》16 节）。
- **main 流水线独立 job**：Playwright E2E 在 main 流水线单独成 job 运行，不阻塞 MR 流水线（见《[项目规划说明](../../../规划/项目规划说明.md#sel-ops)》3.4 节 GitLab CI）。
- **E2E 环境**：服务容器起 backend（SQLite）与前端产物，job 内自包含（见《[开发部署规划](../../../规划/开发部署规划.md#workflow)》7 节）。
- **测试报告与归档**：Playwright 生成自动化测试报告（CI 产物归档），结果经官方插件导入 Kiwi TCMS（见《[项目规划说明](../../../规划/项目规划说明.md#test-report)》16.5 节）。
- **移动端兼容基线**：设备模拟覆盖移动端 H5（审批/通知/查询链路），支撑「浏览器与移动端真机兼容基线」验收（见《[项目规划说明](../../../规划/项目规划说明.md#plan)》20 节）。
- **替代 Selenium**：自动等待 + 录制器 + 跨浏览器，替代 Selenium 的手工等待与冗长样板（见《[项目规划说明](../../../规划/项目规划说明.md#sel-frontend)》3.2 节）。
...
- **移动端用例**：用设备模拟（iPhone 等）跑 H5 链路，真机兼容基线另做人工验证（见《[项目规划说明](../../../规划/项目规划说明.md#plan)》20 节）。
...
| 文档 | 说明 |
| --- | --- |
| 《[项目规划说明](../../../规划/项目规划说明.md#stack-frontend)》2.2 节 | 前端技术栈（Playwright 条目） |
| 《[项目规划说明](../../../规划/项目规划说明.md#sel-frontend)》3.2 节 | 选型理由：自动等待、录制器、跨浏览器，替代 Selenium |
| 《[项目规划说明](../../../规划/项目规划说明.md#test)》16 节 | 测试策略：E2E 覆盖范围与报告归档 |
| 《[项目规划说明](../../../规划/项目规划说明.md#sel-ops)》3.4 节 | GitLab CI：main 流水线 Playwright 独立 job |
...
| 《[开发部署规划](../../../规划/开发部署规划.md#workflow)》7 节 | E2E 环境：服务容器起 backend 与前端产物 |
