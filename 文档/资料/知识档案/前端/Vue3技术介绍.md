...
> 渐进式 JavaScript 前端框架 · 本项目双端（PC + H5）统一基础
...
- **定位**：本项目前端核心框架，PC 管理端与移动端 H5 双工程的基础。
...
| 选项式 API（Options API） | Vue 2 风格：data/computed/methods 分块书写，Vue 3 保留兼容，本项目以组合式为主 |
...
| Angular | 全家桶一体化、约束强，但体积大、学习曲线陡 | 过重，与本项目轻快迭代目标不符 |
...
| create-vue 脚手架 | https://github.com/vuejs/create-vue | 官方工程脚手架，本项目工程初始化参考 |
