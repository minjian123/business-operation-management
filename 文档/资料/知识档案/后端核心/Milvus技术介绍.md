...
- **独立部署**：milvus + etcd 容器组，MinIO 复用（《[开发部署规划](../../../规划/开发部署规划.md)》第五批，阶段十五引入）；端口 19530 仅内网。
...
| 《[项目规划说明](../../../规划/项目规划说明.md#sel-backend)》3.1 节 | 向量检索选型与租户隔离约束 |
| 《[项目规划说明](../../../规划/项目规划说明.md#tables)》6 节 | `ai_file_segment` 表：分段文本落库、向量存 Milvus |
| 《[项目规划说明](../../../规划/项目规划说明.md#env)》17 节 | Milvus（含 etcd）随阶段十五加入 Compose |
...
| 《[开发部署规划](../../../规划/开发部署规划.md)》 | 第五批部署（milvus + etcd）、端口 19530 |
