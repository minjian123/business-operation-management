...
- 字符集 utf8mb4；连接池按 worker 数规划（≤ 70% max_connections）；慢查询日志开发联调用（见《[项目规划说明](../../../规划/项目规划说明.md#dbrule)》11.1 节与《[开发部署规划](../../../规划/开发部署规划.md)》，部署口径见《[开发服务器部署使用说明总览](../../开发服务器/linux/开发服务器部署使用说明总览.md)》）。
