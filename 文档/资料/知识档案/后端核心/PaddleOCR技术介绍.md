...
- **部署**：本地 CPU/GPU 推理（《[开发部署规划](../../../规划/开发部署规划.md)》第五批，按需本地部署，可选）。
...
| 《[项目规划说明](../../../规划/项目规划说明.md#sel-backend)》3.1 节 | OCR 默认本地 PaddleOCR、可切换多模态 API 的选型说明 |
| 《[项目规划说明](../../../规划/项目规划说明.md#plan)》20 节 | 阶段十五「AI 能力」验收标准（含 OCR 与文件自动分类） |
...
| 《[开发部署规划](../../../规划/开发部署规划.md)》 | 第五批：PaddleOCR 按需本地部署（可选） |
