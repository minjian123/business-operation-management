...
- 作为《[项目规划说明](../../../规划/项目规划说明.md#stack-eng)》2.3 节指定的 Python 包管理工具，替代 pip + venv 传统组合。
...
- uv.lock 锁定依赖版本（选型依据见《[项目规划说明](../../../规划/项目规划说明.md#sel-eng)》3.3 节）：本地与 CI 安装结果一致，FastAPI 等快速迭代的框架升级前先跑全量测试。
...
- CI 流水线：MR 流水线用 `uv sync` 安装依赖后执行 ruff + pytest（见《[项目规划说明](../../../规划/项目规划说明.md#sel-ops)》3.4 节），与本地命令同源。
...
- **Python 版本**：项目要求 Python 3.14+，用 `uv python install` 统一装解释器；若某核心依赖与 3.14 不兼容，按《[项目规划说明](../../../规划/项目规划说明.md#sel-backend)》3.1 节口径整体回退 3.13。
...
| 文档 | 说明 |
| --- | --- |
| 《[项目规划说明](../../../规划/项目规划说明.md#stack-eng)》2.3 节 | 技术栈：Python 包管理 = uv |
| 《[项目规划说明](../../../规划/项目规划说明.md#sel-eng)》3.3 节 | 选型说明：uv 一体化管理依赖与虚拟环境 |
